...
<?php $__env->startSection('title', 'Buat Resep Baru - Aplikasi Data Obat'); ?>
...
<div class="space-y-6">
    ...
    <div class="bg-white shadow sm:rounded-lg">
        <div class="px-4 py-5 sm:p-6">
            <form action="<?php echo e(route('resep.store')); ?>" method="POST" id="resepForm">
                <?php echo csrf_field(); ?>
                <div class="grid grid-cols-1 gap-6">
                    <div>
                        ...
                        <select name="kunjungan_id" id="kunjungan_id" required
                            ...
                            <?php $__currentLoopData = $kunjungan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($k->id); ?>" <?php echo e(request('kunjungan_id') == $k->id ? 'selected' : ''); ?>>
                                    <?php echo e($k->pasien->nama); ?> - <?php echo e($k->tanggal_kunjungan->format('d/m/Y')); ?>
                                    ...
                                    <div>
                                        ...
                                        <select name="obat_ids[]" class="obat-select mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" required>
                                            ...
                                            <?php $__currentLoopData = $obat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $o): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($o->id); ?>" data-harga="<?php echo e($o->harga); ?>" data-kandungan="<?php echo e($o->kandungan); ?>" data-stok="<?php echo e($o->stok); ?>">
...
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Msi-Modern\Aplikasi Data Obat\manajemen-obat\resources\views/resep/create.blade.php ENDPATH**/ ?>