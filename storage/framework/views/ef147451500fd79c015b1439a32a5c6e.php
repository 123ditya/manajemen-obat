...
<?php $__env->startSection('title', 'Edit Obat - Aplikasi Data Obat'); ?>
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="nama_obat" id="nama_obat" required
                               ...
                               value="<?php echo e(old('nama_obat', $obat->nama_obat)); ?>" placeholder="Masukkan nama obat">
                    </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea name="kandungan" id="kandungan" rows="4" required
                                  class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                  placeholder="Masukkan kandungan obat"><?php echo e(old('kandungan', $obat->kandungan)); ?></textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <input type="number" name="harga" id="harga" required min="0" step="100"
                                   ...
                                   value="<?php echo e(old('harga', $obat->harga)); ?>" placeholder="0">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="stok" id="stok" required min="0"
                               class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                               value="<?php echo e(old('stok', $obat->stok)); ?>" placeholder="0">
                    </div>
                </div>
...
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Msi-Modern\Aplikasi Data Obat\manajemen-obat\resources\views/obat/edit.blade.php ENDPATH**/ ?>