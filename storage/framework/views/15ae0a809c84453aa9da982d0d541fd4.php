...
<?php $__env->startSection('title', 'Edit Resep - Aplikasi Data Obat'); ?>
...
<div class="space-y-6">
    ...
    <div class="bg-white shadow sm:rounded-lg">
        <div class="px-4 py-5 sm:p-6">
            <form action="<?php echo e(route('resep.update', $resep->id)); ?>" method="POST" id="resepForm">
                <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 gap-6">
                    <div>
                        ...
                        <div id="obatList" class="space-y-4">
                            <?php $__currentLoopData = $resep->resepObat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $resepObat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="obat-item border rounded-lg p-4">
                                <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
                                    <div>
                                        ...
                                        <select name="obat_ids[]" class="obat-select mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" required>
                                            ...
                                            <?php $__currentLoopData = $obat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $o): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($o->id); ?>" data-harga="<?php echo e($o->harga); ?>" data-kandungan="<?php echo e($o->kandungan); ?>" data-stok="<?php echo e($o->stok); ?>" <?php echo e($resepObat->obat_id == $o->id ? 'selected' : ''); ?>>
                                                    <?php echo e($o->nama_obat); ?> (Stok: <?php echo e($o->stok); ?>)
                                                </option>
                                    ...
                                    <div>
                                        ...
                                        <input type="number" name="jumlah[]" class="jumlah-input mt-1 block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" min="1" value="<?php echo e($resepObat->jumlah); ?>" required>
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700">Harga Satuan</label>
                                        <input type="text" class="harga-satuan mt-1 block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm bg-gray-50 sm:text-sm" value="Rp <?php echo e(number_format($resepObat->harga_satuan, 0, ',', '.')); ?>" data-harga="<?php echo e($resepObat->harga_satuan); ?>" readonly>
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700">Subtotal</label>
                                        <input type="text" class="subtotal mt-1 block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm bg-gray-50 sm:text-sm" value="Rp <?php echo e(number_format($resepObat->jumlah * $resepObat->harga_satuan, 0, ',', '.')); ?>" readonly>
                                    </div>
                                ...
                                <div class="mt-2">
                                    <span class="text-sm text-gray-500 kandungan-text"><?php echo e($resepObat->obat->kandungan); ?></span>
                                </div>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    ...
                    <div class="border-t pt-4">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-lg font-bold text-blue-600" id="totalHarga">Rp <?php echo e(number_format($resep->resepObat->sum(function($ro) { return $ro->jumlah * $ro->harga_satuan; }), 0, ',', '.')); ?></span>
                        </div>
                    </div>
                </div>

                <div class="mt-6 flex justify-end space-x-3">
                    <a href="<?php echo e(route('resep.index')); ?>" class="bg-gray-300 text-gray-700 px-4 py-2 rounded-md hover:bg-gray-400 transition duration-200">
                        Batal
                    </a>
...
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Msi-Modern\Aplikasi Data Obat\manajemen-obat\resources\views/resep/edit.blade.php ENDPATH**/ ?>