...
@section('title', 'Edit Kunjungan - Aplikasi Data Obat')
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea name="keluhan" id="keluhan" rows="4" required
                                  class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                  placeholder="Masukkan keluhan pasien">{{ old('keluhan', $kunjungan->keluhan) }}</textarea>
                    </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea name="diagnosa" id="diagnosa" rows="4" required
                                  class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                  placeholder="Masukkan diagnosa">{{ old('diagnosa', $kunjungan->diagnosa) }}</textarea>
                    </div>
                </div>

                <div class="mt-6 flex justify-end space-x-3">
                    <a href="{{ route('kunjungan.index') }}" class="bg-gray-300 text-gray-700 px-4 py-2 rounded-md hover:bg-gray-400 transition duration-200">
                        Batal
                    </a>
