...
<?php $__env->startSection('title', 'Catat Kunjungan Baru - Aplikasi Data Obat'); ?>

<?php $__env->startSection('content'); ?>
<div class="space-y-6">
    <div class="flex justify-between items-center">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Catat Kunjungan Baru</h1>
            <p class="mt-2 text-gray-600">Catat kunjungan pasien baru</p>
        </div>
    ...
    <div class="bg-white shadow sm:rounded-lg">
        <div class="px-4 py-5 sm:p-6">
            <form action="<?php echo e(route('kunjungan.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <div>
                        ...
                        <select name="pasien_id" id="pasien_id" required
                            ...
                            <?php $__currentLoopData = $pasien; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($p->id); ?>" <?php echo e(old('pasien_id') == $p->id ? 'selected' : ''); ?>>
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal_kunjungan" id="tanggal_kunjungan" required
                               ...
                               value="<?php echo e(old('tanggal_kunjungan', date('Y-m-d'))); ?>">
                    </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea name="keluhan" id="keluhan" rows="4" required
                                  class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                  placeholder="Masukkan keluhan pasien"><?php echo e(old('keluhan')); ?></textarea>
                    </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea name="diagnosa" id="diagnosa" rows="4" required
                                  class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                  placeholder="Masukkan diagnosa"><?php echo e(old('diagnosa')); ?></textarea>
                    </div>
                </div>
...
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Msi-Modern\Aplikasi Data Obat\manajemen-obat\resources\views/kunjungan/create.blade.php ENDPATH**/ ?>