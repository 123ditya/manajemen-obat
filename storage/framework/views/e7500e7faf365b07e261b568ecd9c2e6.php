...
<?php $__env->startSection('title', 'Tambah Pasien Baru - Aplikasi Data Obat'); ?>
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="nama" id="nama" required
                               ...
                               value="<?php echo e(old('nama')); ?>" placeholder="Masukkan nama lengkap">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="no_telp" id="no_telp" required
                               class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                               value="<?php echo e(old('no_telp')); ?>" placeholder="Contoh: 08123456789">
                    </div>
...
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Msi-Modern\Aplikasi Data Obat\manajemen-obat\resources\views/pasien/create.blade.php ENDPATH**/ ?>